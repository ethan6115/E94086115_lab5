...
class TowerGroup:
    ...
    def upgrade(self):
        ...
        if self.selected_tower.level <5:     #如果塔的level小於5
            self.selected_tower.level+=1     #將塔的level+1
    ...
    def sell(self):
        ...
        self.__towers.remove(self.selected_tower)   #將tower從self.__towers的list中移除
        self.upgrade_menu = None                    #將self.upgrade_menu重設
        self.selected_tower = None                  #將self.selected_tower重設
